...
@powershell -NoProfile -ExecutionPolicy unrestricted -Scope Process -Command "$ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest 'https://www.nuget.org/nuget.exe' -OutFile '%CACHED_NUGET%'"
